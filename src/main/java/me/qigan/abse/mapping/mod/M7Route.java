...
public class M7Route extends Module {
    ...
    public static List<BBox> bounds = new ArrayList<BBox>(Arrays.asList(
            ...
            new BBox(58, 124, 122,59, 123, 114, Blocks.air.getDefaultState()).category(Category.CORE),
            new BBox(58, 122, 117,58, 122, 117, Blocks.air.getDefaultState()).category(Category.CORE),
            new BBox(57, 126, 122, 61, 125, 122, Blocks.cobblestone_wall.getDefaultState()).category(Category.CORE),
